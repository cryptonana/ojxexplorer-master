...
exports.masternodes_page = {
  ...
  //                   Table data is populated via the /ext/masternodelist api
  "masternode_table": {
    // page_length_options: An array of page length options that determine how many items/records to display in the table at any given time
    "page_length_options": [ 10, 25, 50, 75, 100, 250, 500, 1000 ],
    // items_per_page: The default amount of items/records to display in the table at any given time
...
exports.network_page = {
  ...
  //                    Table data is populated via the /ext/getpeerinfo api
  "connections_table": {
    // page_length_options: An array of page length options that determine how many items/records to display in the table at any given time
...
exports.api_page = {
  ...
  "public_apis": {
    ...
    "ext": {
      ...
      // getpeerinfo: a collection of settings that pertain to the /ext/getpeerinfo api endpoint
      ...
      "getpeerinfo": {
        // enabled: Enable/disable the /ext/getpeerinfo api endpoint (true/false)
        //          If set to false, the /ext/getpeerinfo api will be completely disabled for public use (no definition on the api page and a disabled error msg if you try to call the endpoint directly) but the api will still be available internally to the explorer
        "enabled": true
      },
      ...
      // masternodelist: a collection of settings that pertain to the /ext/masternodelist api endpoint
      ...
      "masternodelist": {
        // enabled: Enable/disable the /ext/masternodelist api endpoint (true/false)
        //          If set to false, the /ext/masternodelist api will be completely disabled for public use (no definition on the api page and a disabled error msg if you try to call the endpoint directly) but the api will still be available internally to the explorer
        "enabled": true
      },
...
exports.api_cmds = {
  ...
  // masternodelist: Returns a json array containing status information for all masternodes on the network
  "masternodelist": "listmasternodes",
...
exports.loadSettings = function loadSettings() {
  ...
  if (json_settings != null) {
    ...
    json_settings = fix_deprecated_setting(json_settings, 'public_api.ext.getpeerinfo', 'api_page.public_apis.ext.getpeerinfo.enabled');
    json_settings = fix_deprecated_setting(json_settings, 'public_api.ext.masternodelist', 'api_page.public_apis.ext.masternodelist.enabled');
